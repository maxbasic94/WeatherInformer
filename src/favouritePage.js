...
function createCitiesList(citiesArr) {
   ...
   citiesArr.slice(0, 5).forEach((item, index) => {
      ...
      li.innerHTML = `${name}, ${country_name} <svg class="addToFavourite" fill="white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 172 172">
      ...
      li.addEventListener('click', (event) => {
         ...
         console.log(favouriteCitiesArr);  
      })
   });
